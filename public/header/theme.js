document.addEventListener("DOMContentLoaded", () => {
  ...
  const darkSvg =
    '<svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-moon"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>'; // Replace with actual SVG content

  const updateSvg = () => {
    if (rootElement.classList.contains("dark")) {
      toggleSwitch.innerHTML = darkSvg;
      logo.src = "images/logo-dark-removebg-preview.png";
    } else {
      toggleSwitch.innerHTML = lightSvg;
      logo.src = "images/logo-white-removebg-preview.png";
    }
  };
  ...
  // Set timer to set transition after half a second
  // otherwise weird animation happens when loading in dark mode.
  setTimeout(() => {
